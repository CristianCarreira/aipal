...
const pendingAgentWork = new Set();
function trackAgentWork(work) {
  pendingAgentWork.add(work);
...
const memoryService = createMemoryService({
  ...
  extractImageTokens,
  imageDir: IMAGE_DIR,
  memoryCaptureMaxChars: MEMORY_CAPTURE_MAX_CHARS,
...
const agentRunner = createAgentRunner({
  ...
  resolveThreadId,
  shellQuote,
  threadMaxContextChars: THREAD_MAX_CONTEXT_CHARS,
...
const { handleCronTrigger, getRunningJobs: getRunningCronJobs, getJobLogs: getCronJobLogs } = createCronHandler({
  bot,
...
bootstrapApp({
  ...
  installShutdownHooks: () =>
    installShutdownHooks({
      bot,
      getCronScheduler: () => cronScheduler,
      getPendingAgentWork: () => pendingAgentWork,
