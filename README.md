...
- `AIPAL_MEMORY_RETRIEVAL_LIMIT`: max retrieved memory lines injected per request (default: 5)
- `AIPAL_THREAD_ROTATION_TURNS`: rotate agent thread after N turns to limit accumulated context; 0 = disabled (default: 0)
